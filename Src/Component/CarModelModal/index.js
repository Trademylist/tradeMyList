                    ...
                    modelList.map((makeitem, makeindex) => {
                      return(
                        <View style={{flexDirection:'row'}} key={makeindex}>
                          <TouchableOpacity onPress={()=>props.getcarmodel(makeitem)}><Text style={{ fontFamily:"Roboto-Bold" , fontSize: 16, fontWeight: "bold", color: "#000", textAlign: 'left', alignSelf: "flex-start", marginLeft: 28, marginTop: 15}}>{makeitem}</Text></TouchableOpacity>
                          {
