...
export default class MyListingMenu extends Component {
  ...
  getStateFromPath = async () => {
    ...
    userdata.username != null || userdata.username != "" ? this.setState({userInitial: userdata.username.charAt(0).toUpperCase()}) : this.setState({userInitial: ""})
      this.setState({
        UserData: userdata,
      });
    } catch (e) {
  ...
  getReviewList = async () => {
    ...
    if (value !== null) {
      await axios
        .get('https://trademylist.com:8936/app_seller/review', {
          headers: {
            'x-access-token': value.token,
          },
        })
        ...
        <SafeAreaView style={{flex:1}}>
          <View style={styles.Container}>
            ...
            <View
              ...
              <View
                style={{alignItems: 'flex-start', width: Devicewidth / 2.5}}>
                <Text
                  style={{
              ...
              <TouchableOpacity
                ...
                ) : this.state.UserData.username == null || this.state.UserData.username === "" ? (
                  <Image
                ...
                (
                    ...
                    <Text style={{fontSize:65,textAlign:"center",color:"#e3e4e8",left:1,top:-3}}>{this.state.userInitial}</Text>
                  </View>
                )}
              </TouchableOpacity>
            </View>
            ...
            {this.state.Product || this.state.Commercial ? (
                  ...
                  <FlatList
                    ...
                    renderItem={({item}) => (
                      <ProductListing
                        ...
                        // process='general'
                        process={
                          this.state.Commercial ? 'commercial' : 'general'
                        }
                      />
                    )}
