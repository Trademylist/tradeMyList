  ...
  getsellerDetailsPath = async sellerId => {
    try {
      ...
      if (value !== null) {
        ...
        await axios
          .post('https://trademylist.com:8936/app_user/get_review', object, {
            headers: {
              'x-access-token': value.token,
            },
          })
          .then(response => {
            console.log("USERDATA:",response.data.data.user_details.username.charAt(0).toUpperCase() )
            this.setState({
              userInitial:response.data.data.user_details.username.charAt(0).toUpperCase(),
    ...
    if (data.length > 0) {
      data.map(async (userData, userIndex) => {
        try {
          ...
          if (value !== null) {
            await axios
              .get('https://trademylist.com:8936/user/' + userData.sender_id, {
                headers: {
                  'x-access-token': value.token,
                },
              })
      ...
      <SafeAreaView style={styles.Container}>
        <View style={styles.Container}>
          <View style={styles.Container1}>
            ...
            <View style={styles.HeadrIconContainer}>
              <TouchableOpacity
                ...
                <Image
                  source={require('../../Assets/BackIconLeft.png')}
                  style={{height: '100%', width: '100%',resizeMode:"contain"}}></Image>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => this.HandelReportandBlock()}
                style={{
          ...
          <BlockandReportOptionModal
            ...
            OpenReportModal={this.OpenReport}></BlockandReportOptionModal>

          <BlockModal
            modalProps={this.state.blockModal}
            onPressBlockClose={() => this.closeBlockModal()}
            navigation={this.props.navigation}
            seller_Id={this.props.route.params.sellerId}></BlockModal>
          <ReportModal
            modalProps={this.state.reportModal}
            onPressReportClose={() => this.closeReportModal()}
            navigation={this.props.navigation}
            seller_Id={this.props.route.params.sellerId}></ReportModal>
          <View
            style={{
                ...
                {/* <View style={{width: '35%'}}> */}
                  <TouchableOpacity
                    ...
                    {this.state.UserData.login_type == null ? (
                      <Image
                        source={require('../../Assets/Email_Black.png')}
                        style={{height: 15, width: 16}}></Image>
            ...
            <TouchableOpacity
              ...
              this.state.UserData.username == null ? (
                <Image
                  ...
                  :
                (<View style={{height:"90%",width:"90%",justifyContent:"center",alignItems:"center",borderRadius:100,backgroundColor:"#202336"}}>

                  <Text style={{fontSize:65,textAlign:"center",color:"#e3e4e8",top:0,left:0}}>{this.state.userInitial}</Text>
                </View>
              )}
            </TouchableOpacity>
          </View>
          ...
          <View
            ...
            {this.state.Product == true ? (
              <TouchableOpacity
                onPress={() => this.handelProduct()}
                style={{
                  width: Devicewidth / 3,
                  height: Deviceheight / 16,
                  alignItems: 'center',
                  justifyContent: 'center',
                  borderBottomColor: '#383ec1',
                  borderBottomWidth: 2,
                }}>
                <Text
                  style={{
          ...
          {this.state.Product == true || this.state.Commercial == true ? (
            ...
            contentContainerStyle={{
              ...
              <Text
                ...
                {this.state.UserData.username} is usally described as
              </Text>
              <View
                style={{
                  alignItems: 'flex-start',
                ...
                <View
                  ...
                  <Text
                    ...
                    {this.state.FastDeliveryCommentCount}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <Text
                    ...
                    {this.state.FriendlyCommentCount}
                  </Text>
                </View>
              </View>
              <Text
              ...
              <View style={styles.FlatListContainerReview}>
                <FlatList
                  ...
                  renderItem={({item}) => (
                    <TouchableOpacity
                      onPress={() =>
                        this.props.navigation.push('sellerDetails', {
                          sellerId: item.sender_id._id,
                        })
                      }
                      ...
                      <View
                        ...
                        <View
                          ...
                          {item.sender_id.image === '' ? (
                            ...
                            <Image
                              source={{uri: item.sender_id.image}}
                              style={{
                                height: '100%',
                                width: '100%',
                                borderRadius: 360,
